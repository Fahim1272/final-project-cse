{status === 'loading' ?
      ...
      <div className="pt-6">
        ...
        {/* Image gallery */}
        <div>
          <div id='app' className="mx-auto mt-6 max-w-2xl h-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
            <Swiper
              style={{
          ...
          {/* Product info */}
          <div className="mx-auto mt-96 max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                    ...
                    {[0, 1, 2, 3, 4].map((rating) => (
                      <StarIcon
                        ...
                        className={classNames(
                          product.rating.average > rating ? 'text-gray-900' : 'text-gray-200',
